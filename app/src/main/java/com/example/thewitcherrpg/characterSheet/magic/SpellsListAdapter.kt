...
class SpellsListAdapter(con: Context): RecyclerView.Adapter<SpellsListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val tags = context.resources.getStringArray(R.array.spells_list_data)
        for (tag in tags) {
