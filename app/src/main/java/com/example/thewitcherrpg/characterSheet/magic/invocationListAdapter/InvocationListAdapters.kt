...
class NoviceDruidInvoListAdapter(con: Context, val itemClick: (String) -> Unit) : RecyclerView.Adapter<NoviceDruidInvoListAdapter.MyViewHolder>()  {
...
class JourneymanDruidInvoListAdapter(con: Context, val itemClick: (String) -> Unit) : RecyclerView.Adapter<JourneymanDruidInvoListAdapter.MyViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (addSpell){
            ...
            val tags = context.resources.getStringArray(R.array.journeyman_spells_list_data)
            for (tag in tags) {
