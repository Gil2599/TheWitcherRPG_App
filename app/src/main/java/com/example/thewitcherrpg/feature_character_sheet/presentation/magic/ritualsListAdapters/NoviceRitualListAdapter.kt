package com.example.thewitcherrpg.feature_character_sheet.presentation.magic.ritualsListAdapters
...
class NoviceRitualListAdapter(con: Context, val itemClick: (String) -> Unit) : RecyclerView.Adapter<NoviceRitualListAdapter.NoviceViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoviceViewHolder, position: Int) {
        ...
        if (addSpell){
            ...
            val tags = context.resources.getStringArray(R.array.novice_rituals_list_data)
            for (tag in tags) {
