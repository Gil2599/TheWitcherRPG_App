package com.example.thewitcherrpg.feature_character_sheet
...
class SharedViewModel : ViewModel() {
    ...
    val journeymanPreacherInvocations: LiveData<ArrayList<MagicItem>> =
        _journeymanPreacherInvocations
    ...
    fun addArmor(itemString: String) {
        ...
        when (pair[8]) {
            "LHead" -> {
                ...
                val itemObject = EquipmentItem(
                    armorName, stoppingPower, stoppingPower,
    ...
    fun updateItemSP(
        itemObject: EquipmentItem,
        increase: Boolean,
        armorType: EquipmentTypes?
    ): Int {
    ...
    fun onSaveFinal(): Character {
        ...
        return Character(
            ...
            journeymanSpells,
            masterSpells,
            noviceDruidInvocations,
            journeymanDruidInvocations,
            masterDruidInvocations,
            novicePreacherInvocations,
            journeymanPreacherInvocations,
            masterPreacherInvocations,
            archPriestInvocations,
            headEquipment,
            equippedHead,
            chestEquipment,
            equippedChest,
    ...
    fun increaseStat(stat: Int) {
        when (stat) {
            1 -> _intelligence.value = if (onStatChange(
                    _intelligence.value!!,
                    true
                )
            ) _intelligence.value!!.plus(1) else _intelligence.value
            2 -> _ref.value =
                if (onStatChange(_ref.value!!, true)) _ref.value!!.plus(1) else _ref.value
            3 -> _dex.value =
                if (onStatChange(_dex.value!!, true)) _dex.value!!.plus(1) else _dex.value
            4 -> {
                _body.value = if (onStatChange(
                        _body.value!!,
                        true
                    )
                ) _body.value!!.plus(1) else _body.value; updateDerivedStats()
            }
            5 -> {
                _spd.value = if (onStatChange(
                        _spd.value!!,
                        true
                    )
                ) _spd.value!!.plus(1) else _spd.value; updateDerivedStats()
            }
            6 -> _emp.value =
                if (onStatChange(_emp.value!!, true)) _emp.value!!.plus(1) else _emp.value
            7 -> _cra.value =
                if (onStatChange(_cra.value!!, true)) _cra.value!!.plus(1) else _cra.value
            8 -> {
                _will.value = if (onStatChange(
                        _will.value!!,
                        true
                    )
                ) _will.value!!.plus(1) else _will.value; updateDerivedStats()
            }
            9 -> _luck.value =
                if (onStatChange(_luck.value!!, true)) _luck.value!!.plus(1) else _luck.value
            10 -> _stun.value = _stun.value!!.plus(1)
            11 -> {
                _run.value = _run.value!!.plus(1); updateDerivedStats()
            }
    ...
    fun decreaseStat(stat: Int) {
        when (stat) {
            ...
            ) _intelligence.value!!.minus(1) else _intelligence.value
            2 -> _ref.value =
                if (onStatChange(_ref.value!!, false)) _ref.value!!.minus(1) else _ref.value
            3 -> _dex.value =
                if (onStatChange(_dex.value!!, false)) _dex.value!!.minus(1) else _dex.value
            4 -> {
                _body.value = if (onStatChange(
                        _body.value!!,
                        false
                    )
                ) _body.value!!.minus(1) else _body.value; updateDerivedStats()
            }
            5 -> {
                _spd.value = if (onStatChange(
                        _spd.value!!,
                ...
                ) _spd.value!!.minus(1) else _spd.value; updateDerivedStats()
            }
            6 -> _emp.value =
                if (onStatChange(_emp.value!!, false)) _emp.value!!.minus(1) else _emp.value
            7 -> _cra.value =
                if (onStatChange(_cra.value!!, false)) _cra.value!!.minus(1) else _cra.value
            8 -> {
                _will.value = if (onStatChange(
                        _will.value!!,
                        false
                    )
                ) _will.value!!.minus(1) else _will.value; updateDerivedStats()
            }
            9 -> _luck.value =
                if (onStatChange(_luck.value!!, false)) _luck.value!!.minus(1) else _luck.value
            10 -> _stun.value = _stun.value!!.minus(1)
            11 -> {
                _run.value = _run.value!!.minus(1); updateDerivedStats()
            }
    ...
    fun increaseSkill(stat: Int) {
        when (stat) {
            1 -> _awareness.value = if (onSkillChange(
                    _awareness.value!!,
                    true
                )
            ) _awareness.value!!.plus(1) else _awareness.value
            2 -> _business.value = if (onSkillChange(
                    _business.value!!,
                    true
                )
            ) _business.value!!.plus(1) else _business.value
            3 -> _deduction.value = if (onSkillChange(
                    _deduction.value!!,
                    true
                )
            ) _deduction.value!!.plus(1) else _deduction.value
            4 -> _education.value = if (onSkillChange(
                    _education.value!!,
                    true
                )
            ) _education.value!!.plus(1) else _education.value
            5 -> _commonSpeech.value = if (onSkillChange(
                    _commonSpeech.value!!,
                    true
                )
            ) _commonSpeech.value!!.plus(1) else _commonSpeech.value
            6 -> _elderSpeech.value = if (onSkillChange(
                    _elderSpeech.value!!,
                    true
                )
            ) _elderSpeech.value!!.plus(1) else _elderSpeech.value
            7 -> _dwarven.value = if (onSkillChange(
                    _dwarven.value!!,
                    true
                )
            ) _dwarven.value!!.plus(1) else _dwarven.value
            8 -> _monsterLore.value = if (onSkillChange(
                    _monsterLore.value!!,
                    true
                )
            ) _monsterLore.value!!.plus(1) else _monsterLore.value
            9 -> _socialEtiquette.value = if (onSkillChange(
                    _socialEtiquette.value!!,
                    true
                )
            ) _socialEtiquette.value!!.plus(1) else _socialEtiquette.value
            10 -> _streetwise.value = if (onSkillChange(
                    _streetwise.value!!,
                    true
                )
            ) _streetwise.value!!.plus(1) else _streetwise.value
            11 -> _tactics.value = if (onSkillChange(
                    _tactics.value!!,
                    true
                )
            ) _tactics.value!!.plus(1) else _tactics.value
            12 -> _teaching.value = if (onSkillChange(
                    _teaching.value!!,
                    true
                )
            ) _teaching.value!!.plus(1) else _teaching.value
            13 -> _wildernessSurvival.value = if (onSkillChange(
                    _wildernessSurvival.value!!,
                    true
                )
            ) _wildernessSurvival.value!!.plus(1) else _wildernessSurvival.value
            14 -> _brawling.value = if (onSkillChange(
                    _brawling.value!!,
                    true
                )
            ) _brawling.value!!.plus(1) else _brawling.value
            15 -> _dodgeEscape.value = if (onSkillChange(
                    _dodgeEscape.value!!,
                    true
                )
            ) _dodgeEscape.value!!.plus(1) else _dodgeEscape.value
            16 -> _melee.value =
                if (onSkillChange(_melee.value!!, true)) _melee.value!!.plus(1) else _melee.value
            17 -> _riding.value =
                if (onSkillChange(_riding.value!!, true)) _riding.value!!.plus(1) else _riding.value
            18 -> _sailing.value = if (onSkillChange(
                    _sailing.value!!,
                    true
                )
            ) _sailing.value!!.plus(1) else _sailing.value
            19 -> _smallBlades.value = if (onSkillChange(
                    _smallBlades.value!!,
                    true
                )
            ) _smallBlades.value!!.plus(1) else _smallBlades.value
            20 -> _staffSpear.value = if (onSkillChange(
                    _staffSpear.value!!,
                    true
                )
            ) _staffSpear.value!!.plus(1) else _staffSpear.value
            21 -> _swordsmanship.value = if (onSkillChange(
                    _swordsmanship.value!!,
                    true
                )
            ) _swordsmanship.value!!.plus(1) else _swordsmanship.value
            22 -> _archery.value = if (onSkillChange(
                    _archery.value!!,
                    true
                )
            ) _archery.value!!.plus(1) else _archery.value
            23 -> _athletics.value = if (onSkillChange(
                    _athletics.value!!,
                    true
                )
            ) _athletics.value!!.plus(1) else _athletics.value
            24 -> _crossbow.value = if (onSkillChange(
                    _crossbow.value!!,
                    true
                )
            ) _crossbow.value!!.plus(1) else _crossbow.value
            25 -> _sleightOfHand.value = if (onSkillChange(
                    _sleightOfHand.value!!,
                    true
                )
            ) _sleightOfHand.value!!.plus(1) else _sleightOfHand.value
            26 -> _stealth.value = if (onSkillChange(
                    _stealth.value!!,
                    true
                )
            ) _stealth.value!!.plus(1) else _stealth.value
            27 -> _physique.value = if (onSkillChange(
                    _physique.value!!,
                    true
                )
            ) _physique.value!!.plus(1) else _physique.value
            28 -> _endurance.value = if (onSkillChange(
                    _endurance.value!!,
                    true
                )
            ) _endurance.value!!.plus(1) else _endurance.value
            29 -> _charisma.value = if (onSkillChange(
                    _charisma.value!!,
                    true
                )
            ) _charisma.value!!.plus(1) else _charisma.value
            30 -> _deceit.value =
                if (onSkillChange(_deceit.value!!, true)) _deceit.value!!.plus(1) else _deceit.value
            31 -> _fineArts.value = if (onSkillChange(
                    _fineArts.value!!,
                    true
                )
            ) _fineArts.value!!.plus(1) else _fineArts.value
            32 -> _gambling.value = if (onSkillChange(
                    _gambling.value!!,
                    true
                )
            ) _gambling.value!!.plus(1) else _gambling.value
            33 -> _groomingAndStyle.value = if (onSkillChange(
                    _groomingAndStyle.value!!,
                    true
                )
            ) _groomingAndStyle.value!!.plus(1) else _groomingAndStyle.value
            34 -> _humanPerception.value = if (onSkillChange(
                    _humanPerception.value!!,
                    true
                )
            ) _humanPerception.value!!.plus(1) else _humanPerception.value
            35 -> _leadership.value = if (onSkillChange(
                    _leadership.value!!,
                    true
                )
            ) _leadership.value!!.plus(1) else _leadership.value
            36 -> _persuasion.value = if (onSkillChange(
                    _persuasion.value!!,
                    true
                )
            ) _persuasion.value!!.plus(1) else _persuasion.value
            37 -> _performance.value = if (onSkillChange(
                    _performance.value!!,
                    true
                )
            ) _performance.value!!.plus(1) else _performance.value
            38 -> _seduction.value = if (onSkillChange(
                    _seduction.value!!,
                    true
                )
            ) _seduction.value!!.plus(1) else _seduction.value
            39 -> _alchemy.value = if (onSkillChange(
                    _alchemy.value!!,
                    true
                )
            ) _alchemy.value!!.plus(1) else _alchemy.value
            40 -> _crafting.value = if (onSkillChange(
                    _crafting.value!!,
                    true
                )
            ) _crafting.value!!.plus(1) else _crafting.value
            41 -> _disguise.value = if (onSkillChange(
                    _disguise.value!!,
                    true
                )
            ) _disguise.value!!.plus(1) else _disguise.value
            42 -> _firstAid.value = if (onSkillChange(
                    _firstAid.value!!,
                    true
                )
            ) _firstAid.value!!.plus(1) else _firstAid.value
            43 -> _forgery.value = if (onSkillChange(
                    _alchemy.value!!,
                    true
                )
            ) _alchemy.value!!.plus(1) else _alchemy.value
            44 -> _pickLock.value = if (onSkillChange(
                    _pickLock.value!!,
                    true
                )
            ) _pickLock.value!!.plus(1) else _pickLock.value
            45 -> _trapCrafting.value = if (onSkillChange(
                    _trapCrafting.value!!,
                    true
                )
            ) _trapCrafting.value!!.plus(1) else _trapCrafting.value
            46 -> _courage.value = if (onSkillChange(
                    _courage.value!!,
                    true
                )
            ) _courage.value!!.plus(1) else _courage.value
            47 -> _hexWeaving.value = if (onSkillChange(
                    _hexWeaving.value!!,
                    true
                )
            ) _hexWeaving.value!!.plus(1) else _hexWeaving.value
            48 -> _intimidation.value = if (onSkillChange(
                    _intimidation.value!!,
                    true
                )
            ) _intimidation.value!!.plus(1) else _intimidation.value
            49 -> _spellCasting.value = if (onSkillChange(
                    _spellCasting.value!!,
                    true
                )
            ) _spellCasting.value!!.plus(1) else _spellCasting.value
            50 -> _resistMagic.value = if (onSkillChange(
                    _resistMagic.value!!,
                    true
                )
            ) _resistMagic.value!!.plus(1) else _resistMagic.value
            51 -> _resistCoercion.value = if (onSkillChange(
                    _resistCoercion.value!!,
                    true
                )
            ) _resistCoercion.value!!.plus(1) else _resistCoercion.value
            52 -> _ritualCrafting.value = if (onSkillChange(
                    _ritualCrafting.value!!,
                    true
                )
            ) _ritualCrafting.value!!.plus(1) else _ritualCrafting.value
    ...
    fun decreaseSkill(stat: Int) {
        when (stat) {
            ...
            ) _awareness.value!!.minus(1) else _awareness.value
            2 -> _business.value = if (onSkillChange(
                    _business.value!!,
                    false
                )
            ) _business.value!!.minus(1) else _business.value
            3 -> _deduction.value = if (onSkillChange(
                    _deduction.value!!,
                    false
                )
            ) _deduction.value!!.minus(1) else _deduction.value
            4 -> _education.value = if (onSkillChange(
                    _education.value!!,
                    false
                )
            ) _education.value!!.minus(1) else _education.value
            5 -> _commonSpeech.value = if (onSkillChange(
                    _commonSpeech.value!!,
                    false
                )
            ) _commonSpeech.value!!.minus(1) else _commonSpeech.value
            6 -> _elderSpeech.value = if (onSkillChange(
                    _elderSpeech.value!!,
                    false
                )
            ) _elderSpeech.value!!.minus(1) else _elderSpeech.value
            7 -> _dwarven.value = if (onSkillChange(
                    _dwarven.value!!,
                    false
                )
            ) _dwarven.value!!.minus(1) else _dwarven.value
            8 -> _monsterLore.value = if (onSkillChange(
                    _monsterLore.value!!,
                    false
                )
            ) _monsterLore.value!!.minus(1) else _monsterLore.value
            9 -> _socialEtiquette.value = if (onSkillChange(
                    _socialEtiquette.value!!,
                    false
                )
            ) _socialEtiquette.value!!.minus(1) else _socialEtiquette.value
            10 -> _streetwise.value = if (onSkillChange(
                    _streetwise.value!!,
                    false
                )
            ) _streetwise.value!!.minus(1) else _streetwise.value
            11 -> _tactics.value = if (onSkillChange(
                    _tactics.value!!,
                    false
                )
            ) _tactics.value!!.minus(1) else _tactics.value
            12 -> _teaching.value = if (onSkillChange(
                    _teaching.value!!,
                    false
                )
            ) _teaching.value!!.minus(1) else _teaching.value
            13 -> _wildernessSurvival.value = if (onSkillChange(
                    _wildernessSurvival.value!!,
                    false
                )
            ) _wildernessSurvival.value!!.minus(1) else _wildernessSurvival.value
            14 -> _brawling.value = if (onSkillChange(
                    _brawling.value!!,
                    false
                )
            ) _brawling.value!!.minus(1) else _brawling.value
            15 -> _dodgeEscape.value = if (onSkillChange(
                    _dodgeEscape.value!!,
                    false
                )
            ) _dodgeEscape.value!!.minus(1) else _dodgeEscape.value
            16 -> _melee.value =
                if (onSkillChange(_melee.value!!, false)) _melee.value!!.minus(1) else _melee.value
            17 -> _riding.value = if (onSkillChange(
                    _riding.value!!,
                    false
                )
            ) _riding.value!!.minus(1) else _riding.value
            18 -> _sailing.value = if (onSkillChange(
                    _sailing.value!!,
                    false
                )
            ) _sailing.value!!.minus(1) else _sailing.value
            19 -> _smallBlades.value = if (onSkillChange(
                    _smallBlades.value!!,
                    false
                )
            ) _smallBlades.value!!.minus(1) else _smallBlades.value
            20 -> _staffSpear.value = if (onSkillChange(
                    _staffSpear.value!!,
                    false
                )
            ) _staffSpear.value!!.minus(1) else _staffSpear.value
            21 -> _swordsmanship.value = if (onSkillChange(
                    _swordsmanship.value!!,
                    false
                )
            ) _swordsmanship.value!!.minus(1) else _swordsmanship.value
            22 -> _archery.value = if (onSkillChange(
                    _archery.value!!,
                    false
                )
            ) _archery.value!!.minus(1) else _archery.value
            23 -> _athletics.value = if (onSkillChange(
                    _athletics.value!!,
                    false
                )
            ) _athletics.value!!.minus(1) else _athletics.value
            24 -> _crossbow.value = if (onSkillChange(
                    _crossbow.value!!,
                    false
                )
            ) _crossbow.value!!.minus(1) else _crossbow.value
            25 -> _sleightOfHand.value = if (onSkillChange(
                    _sleightOfHand.value!!,
                    false
                )
            ) _sleightOfHand.value!!.minus(1) else _sleightOfHand.value
            26 -> _stealth.value = if (onSkillChange(
                    _stealth.value!!,
                    false
                )
            ) _stealth.value!!.minus(1) else _stealth.value
            27 -> _physique.value = if (onSkillChange(
                    _physique.value!!,
                    false
                )
            ) _physique.value!!.minus(1) else _physique.value
            28 -> _endurance.value = if (onSkillChange(
                    _endurance.value!!,
                    false
                )
            ) _endurance.value!!.minus(1) else _endurance.value
            29 -> _charisma.value = if (onSkillChange(
                    _charisma.value!!,
                    false
                )
            ) _charisma.value!!.minus(1) else _charisma.value
            30 -> _deceit.value = if (onSkillChange(
                    _deceit.value!!,
                    false
                )
            ) _deceit.value!!.minus(1) else _deceit.value
            31 -> _fineArts.value = if (onSkillChange(
                    _fineArts.value!!,
                    false
                )
            ) _fineArts.value!!.minus(1) else _fineArts.value
            32 -> _gambling.value = if (onSkillChange(
                    _gambling.value!!,
                    false
                )
            ) _gambling.value!!.minus(1) else _gambling.value
            33 -> _groomingAndStyle.value = if (onSkillChange(
                    _groomingAndStyle.value!!,
                    false
                )
            ) _groomingAndStyle.value!!.minus(1) else _groomingAndStyle.value
            34 -> _humanPerception.value = if (onSkillChange(
                    _humanPerception.value!!,
                    false
                )
            ) _humanPerception.value!!.minus(1) else _humanPerception.value
            35 -> _leadership.value = if (onSkillChange(
                    _leadership.value!!,
                    false
                )
            ) _leadership.value!!.minus(1) else _leadership.value
            36 -> _persuasion.value = if (onSkillChange(
                    _persuasion.value!!,
                    false
                )
            ) _persuasion.value!!.minus(1) else _persuasion.value
            37 -> _performance.value = if (onSkillChange(
                    _performance.value!!,
                    false
                )
            ) _performance.value!!.minus(1) else _performance.value
            38 -> _seduction.value = if (onSkillChange(
                    _seduction.value!!,
                    false
                )
            ) _seduction.value!!.minus(1) else _seduction.value
            39 -> _alchemy.value = if (onSkillChange(
                    _alchemy.value!!,
                    false
                )
            ) _alchemy.value!!.minus(1) else _alchemy.value
            40 -> _crafting.value = if (onSkillChange(
                    _crafting.value!!,
                    false
                )
            ) _crafting.value!!.minus(1) else _crafting.value
            41 -> _disguise.value = if (onSkillChange(
                    _disguise.value!!,
                    false
                )
            ) _disguise.value!!.minus(1) else _disguise.value
            42 -> _firstAid.value = if (onSkillChange(
                    _firstAid.value!!,
                    false
                )
            ) _firstAid.value!!.minus(1) else _firstAid.value
            43 -> _forgery.value = if (onSkillChange(
                    _alchemy.value!!,
                    false
                )
            ...
            ) _pickLock.value!!.minus(1) else _pickLock.value
            45 -> _trapCrafting.value = if (onSkillChange(
                    _trapCrafting.value!!,
                    false
                )
            ) _trapCrafting.value!!.minus(1) else _trapCrafting.value
            46 -> _courage.value = if (onSkillChange(
                    _courage.value!!,
                    false
                )
            ) _courage.value!!.minus(1) else _courage.value
            47 -> _hexWeaving.value = if (onSkillChange(
                    _hexWeaving.value!!,
                    false
                )
            ) _hexWeaving.value!!.minus(1) else _hexWeaving.value
            48 -> _intimidation.value = if (onSkillChange(
                    _intimidation.value!!,
                    false
                )
            ) _intimidation.value!!.minus(1) else _intimidation.value
            49 -> _spellCasting.value = if (onSkillChange(
                    _spellCasting.value!!,
                    false
                )
            ) _spellCasting.value!!.minus(1) else _spellCasting.value
            50 -> _resistMagic.value = if (onSkillChange(
                    _resistMagic.value!!,
                    false
                )
            ) _resistMagic.value!!.minus(1) else _resistMagic.value
            51 -> _resistCoercion.value = if (onSkillChange(
                    _resistCoercion.value!!,
                    false
                )
            ) _resistCoercion.value!!.minus(1) else _resistCoercion.value
            52 -> _ritualCrafting.value = if (onSkillChange(
                    _ritualCrafting.value!!,
                    false
                )
            ) _ritualCrafting.value!!.minus(1) else _ritualCrafting.value
    ...
    private fun updateDerivedStats() {
        ...
        when (_body.value) {
            1, 2 -> {
                _punch.value = "1d6 -4"; _kick.value = "1d6"
            }
            3, 4 -> {
                _punch.value = "1d6 -2"; _kick.value = "1d6 +2"
            }
            5, 6 -> {
                _punch.value = "1d6"; _kick.value = "1d6 +4"
            }
            7, 8 -> {
                _punch.value = "1d6 +2"; _kick.value = "1d6 +6"
            }
            9, 10 -> {
                _punch.value = "1d6 +4"; _kick.value = "1d6 +8"
            }
            11, 12 -> {
                _punch.value = "1d6 +6"; _kick.value = "1d6 +10"
            }
            13 -> {
                _punch.value = "1d6 +8"; _kick.value = "1d6 +12"
            }
        }
    ...
    fun increaseProfSkill(skill: Int) {
        when (skill) {
            1 -> _professionSkillA1.value =
                if (onProfessionSkillChange(_professionSkillA1.value!!, true, "a2"))
                    _professionSkillA1.value!!.plus(1) else _professionSkillA1.value

            2 -> _professionSkillA2.value =
                if (onProfessionSkillChange(_professionSkillA2.value!!, true, "a3"))
                    _professionSkillA2.value!!.plus(1) else _professionSkillA2.value

            3 -> _professionSkillA3.value =
                if (onProfessionSkillChange(_professionSkillA3.value!!, true, "-1"))
                    _professionSkillA3.value!!.plus(1) else _professionSkillA3.value

            4 -> _professionSkillB1.value =
                if (onProfessionSkillChange(_professionSkillB1.value!!, true, "b2"))
                    _professionSkillB1.value!!.plus(1) else _professionSkillB1.value

            5 -> _professionSkillB2.value =
                if (onProfessionSkillChange(_professionSkillB2.value!!, true, "b3"))
                    _professionSkillB2.value!!.plus(1) else _professionSkillB2.value

            6 -> _professionSkillB3.value =
                if (onProfessionSkillChange(_professionSkillB3.value!!, true, "-1"))
                    _professionSkillB3.value!!.plus(1) else _professionSkillB3.value

            7 -> _professionSkillC1.value =
                if (onProfessionSkillChange(_professionSkillC1.value!!, true, "c2"))
                    _professionSkillC1.value!!.plus(1) else _professionSkillC1.value

            8 -> _professionSkillC2.value =
                if (onProfessionSkillChange(_professionSkillC2.value!!, true, "c3"))
                    _professionSkillC2.value!!.plus(1) else _professionSkillC2.value

            9 -> _professionSkillC3.value =
                if (onProfessionSkillChange(_professionSkillC3.value!!, true, "-1"))
    ...
    fun decreaseProfSkill(skill: Int) {
        when (skill) {
            1 -> _professionSkillA1.value =
                if (onProfessionSkillChange(_professionSkillA1.value!!, false, "a2"))
                    _professionSkillA1.value!!.minus(1) else _professionSkillA1.value

            2 -> _professionSkillA2.value =
                if (onProfessionSkillChange(_professionSkillA2.value!!, false, "a3"))
                    _professionSkillA2.value!!.minus(1) else _professionSkillA2.value

            3 -> _professionSkillA3.value =
                if (onProfessionSkillChange(_professionSkillA3.value!!, false, "-1"))
                    _professionSkillA3.value!!.minus(1) else _professionSkillA3.value

            4 -> _professionSkillB1.value =
                if (onProfessionSkillChange(_professionSkillB1.value!!, false, "b2"))
                    _professionSkillB1.value!!.minus(1) else _professionSkillB1.value

            5 -> _professionSkillB2.value =
                if (onProfessionSkillChange(_professionSkillB2.value!!, false, "b3"))
                    _professionSkillB2.value!!.minus(1) else _professionSkillB2.value

            6 -> _professionSkillB3.value =
                if (onProfessionSkillChange(_professionSkillB3.value!!, false, "-1"))
                    _professionSkillB3.value!!.minus(1) else _professionSkillB3.value

            7 -> _professionSkillC1.value =
                if (onProfessionSkillChange(_professionSkillC1.value!!, false, "c2"))
                    _professionSkillC1.value!!.minus(1) else _professionSkillC1.value

            8 -> _professionSkillC2.value =
                if (onProfessionSkillChange(_professionSkillC2.value!!, false, "c3"))
                    _professionSkillC2.value!!.minus(1) else _professionSkillC2.value

            9 -> _professionSkillC3.value =
                if (onProfessionSkillChange(_professionSkillC3.value!!, false, "-1"))
