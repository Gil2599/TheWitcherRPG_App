package com.example.thewitcherrpg.feature_character_sheet.presentation.magic.signsListAdapters
...
class AlternateSignsListAdapter(con: Context, val itemClick: (String) -> Unit) : RecyclerView.Adapter<AlternateSignsListAdapter.SignsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SignsViewHolder, position: Int) {
        ...
        if (addSpell){
            ...
            val tags = context.resources.getStringArray(R.array.alternate_signs_list_data)
            for (tag in tags) {
